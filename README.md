...
React.js based web application for classes `Engineer project`. It allows you to see chart of your mathematical formula and other useful informations.

Teacher: mgr inż. Tomasz Wojtowicz
